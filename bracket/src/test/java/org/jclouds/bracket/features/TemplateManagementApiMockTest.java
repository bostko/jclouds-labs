...
/**
 * Mock tests for the {@link org.jclouds.bracket.features.TemplateManagementApi} class.
 */
...
public class TemplateManagementApiMockTest extends BaseBracketMockTest {
   ...
   public void testList() throws Exception {
      ...
      TemplateManagementApi api = api(BracketApi.class, server.getUrl("/").toString(), getModules()).getTemplateManagementApi();
      try {
