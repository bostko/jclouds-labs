...
@Test(groups = "unit")
public class WorkloadTemplateParseTest extends BaseBracketParseTest<WorkloadTemplate> {

   @Override
   public String resource() {
      return "/workloadtemplate.json";
   }

   @Override
   @Consumes(MediaType.APPLICATION_JSON)
   public WorkloadTemplate expected() {
      return WorkloadTemplate.create(
