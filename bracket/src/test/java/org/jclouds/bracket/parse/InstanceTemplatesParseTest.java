...
@Test(groups = "unit")
public class InstanceTemplatesParseTest extends BaseBracketParseTest<List<InstanceTemplate>> {

   @Override
   public String resource() {
      return "/instancetemplates.json";
   }

   @Override
   @Consumes(MediaType.APPLICATION_JSON)
   public List<InstanceTemplate> expected() {
